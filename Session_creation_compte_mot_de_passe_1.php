...
<BODY>
    ...
    <div class="connexion-droit">
        <span class="titre-connexion">Mot de passe oublié</span>
        <div class="connexion-texte">
      Nous allons vous envoyer un courriel, contenant un lien qui vous permettra de créer un nouveau mot de passe.
       </div><br><br>
    
    <form id="nouvelobs" action="Session_creation_compte_mot_de_passe_2.php" method="post" >
    ...
    <input type="submit" class="vert" id="button" name="valider" value="Envoyer un courriel"/>
    </form>
       <br><br><br><br>
    </div>
