...
<BODY>
	...
	<input type="text" class="session" value="" placeholder="Saisissez votre NOM" name="nom"><br>
	<input type="text" class="session" value="" placeholder="Saisissez votre Prénom" name="prenom"><br>
    ...
    <input type="submit" id="button" name="valider" value="Ouvrir un compte"/>
    </form>
       <?php
   }
   ?>
